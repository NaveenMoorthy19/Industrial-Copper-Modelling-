...
icon='/Users/naveenmoorthy/Desktop/Code/copper image.jpg'
    ...
    if select == 'Selling Price':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('/Users/naveenmoorthy/Desktop/Code/Regressor.pkl','rb') as files:
    ...
    if select == 'Status':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('/Users/naveenmoorthy/Desktop/Code/Classifier.pkl','rb') as files:
...
if selected == 'Home':
    ...
    with col2:
        st.image('/Users/naveenmoorthy/Desktop/Code/copper image.jpg')
...
if selected == "About":
    ...
    st.markdown('''**Hello All,
                I am Naveen Moorthy Click the link below for Profile...**''')
